...
public class CropIV extends ImageView {
	...
	public CropIV(Context context) {
		super(context);
		init(context);
	}

	public CropIV(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public CropIV(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setStat(boolean running){
