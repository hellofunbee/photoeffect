...
public class FillPatternFilter  implements IImageFilter{
    ...
    public FillPatternFilter(Mapp app, int resourceId)
    {
        this.pattern = Image.LoadImage(app, resourceId);
    }
    
    public FillPatternFilter(Mapp app, int resourceId, int Mixture)
    {
    	this.pattern = Image.LoadImage(app, resourceId);
